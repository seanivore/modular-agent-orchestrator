...
def _display_no_workflows_message(search_params: Dict[str, Any]) -> None:
    ...
    if has_search_params:
        message = "[yellow]No workflows found matching your search criteria[" / Path(r"yellow]\n")
        message += "Try adjusting your search parameters or broadening your criteria"
    else:
        message = "[yellow]No workflows available for review[" / Path(r"yellow]\n")
...
def estimate_cost(params: Dict[str, Any] = None) -> float:
    """Estimate review UI operation cost for budget planning"""
