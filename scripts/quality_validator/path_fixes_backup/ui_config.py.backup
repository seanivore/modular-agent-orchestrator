...
def _display_settings_discovery(result: Dict[str, Any]) -> None:
    ...
    console.print(f"Organized into [bold]{len(sections)}[/bold] sections:\n")
...
def _display_config_transfer(result: Dict[str, Any]) -> None:
    ...
    if operation == "export_config":
        ...
        console.print(Panel(
            f"Configuration exported for {export_info.get('username', 'Unknown')}\n" +
        ...
        console.print(Panel(
            f"Imported: [green]{imported_count}[/green] settings\n" +
