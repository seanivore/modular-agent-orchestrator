...
* **Mao's triggered workflows let them take over running your business, one step at a time.** 
  ...
  - With Mao's triggered workflows the [possibilities are endless](./05_AUTOMATING_BUSINESSES.md), including having your entire business run by AI. 
...
*The above we should find other rates of change that people can relate to that can be used as comparisons to emphasize the profundity of the numbers.* 

> -105,000X in 10 years — energy required per token generated*
> -99.7% in 2 years — cost to serve a model 

*These as well. I just separated them becasue they are that much more insane. Every time I see "-105,000X" I fully question myself as to if that really means -105,000 multiplied by itself 105,000 times, even though I know that is how 5X or 10X or 100X is calculated. The number is just that ridiculous that you question your own sanity/knowledge.* 

> Same 360 billion web searches: 
> Google took 11 years = GPT took 2 years 

> Same % drop in cost: 
> Lightbulb took 75 years = 75-word response took 2 years 

*These two can be show using simple bar charts.* 
...
The reality of agentic development and its scalability feels a little insane, but this is just the other side of the 'exponential change' coin. 
...
*Evolution of our SFA to Mao solidified this change, showing us it wasn't just possible, but it made complexity simple.* 
...
*When you don't need to program countless files with logic because you can just explain the workflow to AI, the entire process becomes efficient. Just talk about what you want. It is sort of like code became natural language.* 
...
The result also meant we were only choosing the pathway that was most beneficial to modern businesses on the cutting edge of technology today. 
