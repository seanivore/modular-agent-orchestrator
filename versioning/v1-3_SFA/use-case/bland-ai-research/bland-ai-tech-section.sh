...
# SFA workflow for ai
# Generated from bland-ai-technical-multipart.json

echo "Running ai workflow with 3 phases..."

CONFIG_FILE="/Users/seanivore/Development/single-file-agents/use-case/bland-ai-research/bland-ai-technical-multipart.json"
