...
# Generated from tag-content-config.json

echo "Running content workflow with 1 phases..."

CONFIG_FILE="/Users/seanivore/Development/single-file-agents/use-case/tag-content/tag-content-config.json"
