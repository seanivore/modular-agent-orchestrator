...
6. Have them report, for each file, what is good and what is bad; then implement fixes using the `FILE_STANDARDIZATION_RULES.md` file. 
...
7. **Sequential thinking + full audit** using `FILE_STANDARDIZATION_RULES.md`:
