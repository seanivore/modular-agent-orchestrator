...
1. `./configs/cli/chat/`
2. `./configs/cli/config/`
3. `./configs/cli/continue/`
4. `./configs/cli/default_provider/`
5. `./configs/cli/doctor/`
6. `./configs/cli/dry_run/`
7. `./configs/cli/exit/`
8. `./configs/cli/fix_it/`
9. `./configs/cli/free_only/`
10. `./configs/cli/goal/`
11. `./configs/cli/help/`
12. `./configs/cli/list_tools/`
13. `./configs/cli/login/`
14. `./configs/cli/logout/`
15. `./configs/cli/logs/`
16. `./configs/cli/mao/`
17. `./configs/cli/model/`
18. `./configs/cli/models/`
19. `./configs/cli/onboard/`
20. `./configs/cli/output_directory/`
21. `./configs/cli/privacy/`
22. `./configs/cli/provider/`
23. `./configs/cli/provider_list/`
24. `./configs/cli/providers/`
25. `./configs/cli/restart/`
26. `./configs/cli/review/`
27. `./configs/cli/set_model/`
28. `./configs/cli/setup/`
29. `./configs/cli/stats/`
30. `./configs/cli/tools/`
31. `./configs/cli/update/`
32. `./configs/cli/user_id/`
33. `./configs/cli/variables/`
34. `./configs/cli/variables_explain/`
35. `./configs/cli/verbose/`
36. `./configs/cli/workflow_id/`
37. `./configs/cli/workflows/`
