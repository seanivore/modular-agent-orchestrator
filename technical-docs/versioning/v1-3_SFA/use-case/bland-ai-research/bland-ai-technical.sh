...
# SFA workflow for ai
# Generated from bland-ai-technical-config.json

echo "Running ai workflow with 2 phases..."

CONFIG_FILE="/Users/seanivore/Development/single-file-agents/use-case/bland-ai-research/bland-ai-technical-config.json"
