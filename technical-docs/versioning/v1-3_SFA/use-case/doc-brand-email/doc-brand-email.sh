...
# Generated from doc-brand-email-config.json

echo "Running brand workflow with 3 phases..."

CONFIG_FILE="/Users/seanivore/Development/single-file-agents/use-case/doc-brand-email/doc-brand-email-config.json"
