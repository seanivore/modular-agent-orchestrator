...
# SFA workflow for cheat
# Generated from voice-cheat-sheet-config.json

echo "Running cheat workflow with 3 phases..."

CONFIG_FILE="/Users/seanivore/Development/single-file-agents/use-case/voice-cheat-sheet/voice-cheat-sheet-config.json"
...
echo "cheat workflow completed successfully!"
