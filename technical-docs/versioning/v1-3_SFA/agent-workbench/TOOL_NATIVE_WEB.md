...
The web search tool gives Claude direct access to real-time web content, allowing them to answer questions with up-to-date information beyond its knowledge cutoff. Claude automatically cites sources from search results as part of its answer.

Supported models that web search is available on:
