...
```
!gsutil cp gs://cloud-samples-data/generative-ai/pdf/2312.11805v3_pdf .
...
```
file1 = client.files.upload(file='2312.11805v3_pdf')
...
```
file3 = client.files.upload(file='2312.11805v3_pdf')
...
if client.vertexai:
    file_uris = [\
        'gs://cloud-samples-data/generative-ai/pdf/2312.11805v3_pdf',\
...
Latest\\
\\
Feb 10, 2025](https://github.com/googleapis/python-genai/releases/tag/v1_1_0)
