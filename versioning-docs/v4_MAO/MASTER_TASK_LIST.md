...
Also please look at lines 86 through 122 because we should not have any models or providers hardcoded in here... Also the toke cost calculation looks suspicious because it looks like the Anthropic costs... 

What I added is 279 to 367 -- it said to add methods to "MaoTerminalInterface class" --> directly below that is a "OCTerminalInterface" class....  
...
```
At 490 it says "generated by OC Orchestrator" --> should be Mao. 

Ahhh and then from there down to 618 things like "complete job application package... I swear these were fixed but maybe that was ust the tools. 
