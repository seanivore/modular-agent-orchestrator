...
# SFA workflow for brand
# Generated from doc-brand-social-config.json

echo "Running brand workflow with 3 phases..."

CONFIG_FILE="/Users/seanivore/Development/single-file-agents/use-case/doc-brand-social/doc-brand-social-config.json"
...
echo "brand workflow completed successfully!"
